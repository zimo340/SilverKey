...
def main():
    parser = argparse.ArgumentParser(description="SilverKey模型交互对话")
    ...
    model = SilverKeyForCausalLM(SilverKeyConfig(
    ...
    while True:
        ...
        # 生成回复
        print('🧽 SilverKey: ', end='', flush=True)
        with torch.no_grad():
